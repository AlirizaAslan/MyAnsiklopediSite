...
{//burdaki T article category ımage den herhangi biri hangsinde işlem yaparsak o oluyor
    public class Repository<T> :IRepository<T> where T : class,IEntityBase, new()
    {
        ...
        public async Task<List<T>> GetAllAsycn(Expression<Func<T,bool>>predicate=null,params Expression<Func<T, object>>[]includeProperties)
        {
        ...
        //Task = void async da kullanılır geri değer döndürmez 
